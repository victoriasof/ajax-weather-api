...
function showData(forecast){
    ...
    document.getElementById("img1").src = forecast.list[7].weather.icon;
    ...
    //document.getElementById("img2").src = forecast.list[15].weather.icon;
    ...
    //document.getElementById("img3").src = forecast.list[23].weather.icon;
    ...
    //document.getElementById("img4").src = forecast.list[31].weather.icon;
